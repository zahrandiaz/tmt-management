...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('karung_sales_return_details', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('sales_return_id')->index('karung_sales_return_details_sales_return_id_foreign');
            $table->unsignedBigInteger('product_id')->index('karung_sales_return_details_product_id_foreign');
