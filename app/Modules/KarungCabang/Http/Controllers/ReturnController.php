...
use App\Modules\KarungCabang\Http\Requests\StorePurchaseReturnRequest;
use App\Modules\KarungCabang\Http\Requests\StoreSalesReturnRequest;
use App\Modules\KarungCabang\Models\PurchaseReturn;
use App\Modules\KarungCabang\Models\PurchaseTransaction;
use App\Modules\KarungCabang\Models\SalesReturn;
...
class ReturnController extends ModuleBaseController
{
    ...
    public function salesReturnIndex()
    {
        ...
        $returns = SalesReturn::with('customer', 'originalTransaction')
            ->where('business_unit_id', 2) // <-- TAMBAHKAN FILTER INI
            ->latest()
            ->paginate(15);
        return view('karungcabang::returns.sales.index', compact('returns'));
    }
    ...
    public function createSalesReturn(SalesTransaction $salesTransaction)
    {
        ...
        return view('karungcabang::returns.sales.create', compact('salesTransaction'));
    }
    ...
    public function storeSalesReturn(StoreSalesReturnRequest $request, SalesTransaction $salesTransaction)
    {
        try {
            ...
            return redirect()->route('karungcabang.returns.sales.show', $return->id)
    ...
    public function showSalesReturn(SalesReturn $salesReturn)
    {
        ...
        return view('karungcabang::returns.sales.show', compact('salesReturn'));
    }
    ...
    public function purchaseReturnIndex()
    {
        ...
        return view('karungcabang::returns.purchases.index', compact('returns'));
    }
    ...
    public function createPurchaseReturn(PurchaseTransaction $purchaseTransaction)
    {
        ...
        return view('karungcabang::returns.purchases.create', ['purchaseTransaction' => $loadedTransaction]);
    }
    ...
    public function storePurchaseReturn(StorePurchaseReturnRequest $request, PurchaseTransaction $purchaseTransaction)
    {
        try {
            ...
            return redirect()->route('karungcabang.returns.purchases.show', $return->id)
    ...
    public function showPurchaseReturn(PurchaseReturn $purchaseReturn)
    {
        ...
        return view('karungcabang::returns.purchases.show', compact('purchaseReturn'));
    }
    ...
    public function downloadCreditNotePdf(SalesReturn $salesReturn)
    {
        ...
        $pdf = Pdf::loadView('karungcabang::returns.sales.credit_note_pdf', compact('salesReturn', 'settings'));
    ...
    public function downloadDebitNotePdf(PurchaseReturn $purchaseReturn)
    {
        ...
        $settings = Setting::pluck('setting_value', 'setting_key');
        $pdf = Pdf::loadView('karungcabang::returns.purchases.debit_note_pdf', compact('purchaseReturn', 'settings'));
