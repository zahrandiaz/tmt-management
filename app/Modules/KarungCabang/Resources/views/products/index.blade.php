                    ...
                    <div class="card">
                        <div class="card-header bg-dark text-white d-flex justify-content-between align-items-center">
                            ...
                            <div>
                                ...
                                <a href="{{ route('karungcabang.products.bulk-price.edit') }}" class="btn btn-warning btn-sm">
                                    <i class="bi bi-tags-fill"></i>
                                    Update Harga Massal
                                </a>
                                <a href="{{ route('karungcabang.products.create') }}" class="btn btn-light btn-sm">
                        ...
                        <div class="card-body">
                            ...
                            {{-- Form Pencarian --}}
                            <div class="mb-4">
                                <form action="{{ route('karungcabang.products.index') }}" method="GET">
                                    ...
                                    <tbody>
                                        @forelse ($products as $index => $product)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    @can('update', $product)
                                                    <a href="{{ route('karungcabang.products.edit', $product->id) }}" class="btn btn-warning btn-sm" title="Edit">
                                                        <i class="bi bi-pencil-square"></i>
                                                    </a>
                                                    @endcan
                                                    @can('delete', $product)
                                                    <form action="{{ route('karungcabang.products.destroy', $product->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Apakah Anda yakin ingin menghapus produk ini?');">
                                                        @csrf
                                                        @method('DELETE')
