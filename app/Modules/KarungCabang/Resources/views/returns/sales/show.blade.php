                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header bg-dark text-white d-flex justify-content-between align-items-center">
                            ...
                            <div>
                                <a href="{{ route('karungcabang.returns.sales.credit_note.pdf', $salesReturn->id) }}" class="btn btn-danger btn-sm">
                                    <i class="bi bi-file-earmark-pdf-fill me-1"></i> Download Nota Kredit
                                </a>
                                <a href="{{ route('karungcabang.returns.sales.index') }}" class="btn btn-light btn-sm"><i class="bi bi-arrow-left-circle"></i> Kembali ke Riwayat Retur</a>
                            </div>
                        </div>
                        <div class="card-body">
                            {{-- Informasi Utama --}}
                            <div class="row mb-4">
                                <div class="col-md-6">
                                    ...
                                    <p class="mb-1"><strong>Invoice Asli:</strong> <a href="{{ route('karungcabang.sales.show', $salesReturn->originalTransaction->id) }}">{{ $salesReturn->originalTransaction->invoice_number }}</a></p>
                                </div>
                                <div class="col-md-6">
