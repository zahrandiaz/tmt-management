                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header bg-dark text-white d-flex justify-content-between align-items-center">
                            ...
                            <div>
                                <a href="{{ route('karungcabang.returns.purchases.debit_note.pdf', $purchaseReturn) }}" class="btn btn-danger btn-sm" target="_blank">
                                    <i class="bi bi-file-earmark-pdf-fill"></i> Download Nota Debit
                                </a>
                                <a href="{{ route('karungcabang.returns.purchases.index') }}" class="btn btn-light btn-sm"><i class="bi bi-arrow-left-circle"></i> Kembali ke Riwayat Retur</a>
                            </div>
                        </div>
                        <div class="card-body">
                            {{-- Informasi Utama --}}
                            <div class="row mb-4">
                                <div class="col-md-6">
                                    ...
                                    <p class="mb-1"><strong>Pembelian Asli:</strong> <a href="{{ route('karungcabang.purchases.show', $purchaseReturn->originalTransaction->id) }}">{{ $purchaseReturn->originalTransaction->purchase_code }}</a></p>
                                </div>
                                <div class="col-md-6">
