    ...
    <x-module-layout>
        ...
        <div class="container-fluid">
            ...
            @product-selected-from-gallery.window="handleProductSelection($event.detail)">
                ...
                <form action="{{ route('karungcabang.sales.store') }}" method="POST" @submit="validateForm">
                    @csrf
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-end mt-4">
                                <a href="{{ route('karungcabang.sales.index') }}" class="btn btn-outline-secondary me-2"><i class="bi bi-x-circle"></i> Batal</a>
            ...
            document.addEventListener('alpine:init', () => {
                Alpine.data('productGallery', () => ({
                    ...
                    fetchProducts() {
                        ...
                        const url = `{{ route('karungcabang.products.gallery.api') }}?page=${this.currentPage}&search=${this.searchTerm}`;
