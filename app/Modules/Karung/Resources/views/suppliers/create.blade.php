...
@section('title', 'Tambah Supplier Baru - Modul Toko Karung')
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('karung.suppliers.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('supplier_code') is-invalid @enderror" id="supplier_code" name="supplier_code" value="{{ old('supplier_code') }}">
                                    @error('supplier_code')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="d-flex justify-content-end mt-4">
                            ...
                            <button type="submit" class="btn btn-info text-white"> {{-- Warna tombol bisa disesuaikan --}}
