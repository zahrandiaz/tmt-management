...
<svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
    {{-- Ikon tidak berubah, hanya diringkas --}}
...
{{-- [PERBAIKAN] Wrapper ini mengisi seluruh <main> dari parent --}}
<div class="d-flex flex-grow-1 w-100">
    ...
    {{-- [PERBAIKAN] Area konten menjadi flex column, mengambil sisa ruang --}}
    <div class="d-flex flex-column flex-grow-1" style="min-width: 0;"> {{-- min-width: 0 penting untuk flexbox --}}
        
        {{-- [PERBAIKAN] Bagian ini yang akan scroll, bukan seluruh halaman --}}
        <div class="flex-grow-1" style="overflow-y: auto;">
            <div class="p-3"> {{-- Padding diletakkan di dalam area scroll --}}
        ...
        {{-- [PERBAIKAN] Footer sekarang berada di luar area scroll dan akan menempel di bawah --}}
