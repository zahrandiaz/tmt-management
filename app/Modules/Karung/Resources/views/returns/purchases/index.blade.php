...
@section('title', 'Riwayat Retur Pembelian - Modul Toko Karung')
                                ...
                                @forelse ($returns as $return)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{ route('karung.returns.purchases.show', $return->id) }}" class="btn btn-info btn-sm text-white">Lihat Detail</a>
                                        </td>
                                    </tr>
                                @empty
