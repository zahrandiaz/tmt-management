...
@section('title', 'Laporan Performa Produk')

@section('module-content')
<div class="container-fluid">
    <div class="card">
        {{-- [PERBAIKAN] Mengganti text-white menjadi text-dark agar kontras --}}
                ...
                <table class="table table-striped table-hover table-bordered">
                    <thead class="table-dark">
                        <tr>
                            <th>#</th>
                            <th>Nama Produk</th>
                            <th class="text-center"><a class="text-white" href="{{ route('karung.reports.product_performance', ['sort_by' => 'units_sold', 'sort_order' => $sortBy == 'units_sold' && $sortOrder == 'desc' ? 'asc' : 'desc']) }}">Unit Terjual</a></th>
                            <th class="text-end"><a class="text-white" href="{{ route('karung.reports.product_performance', ['sort_by' => 'total_revenue', 'sort_order' => $sortBy == 'total_revenue' && $sortOrder == 'desc' ? 'asc' : 'desc']) }}">Total Omzet</a></th>
                            <th class="text-end"><a class="text-white" href="{{ route('karung.reports.product_performance', ['sort_by' => 'total_profit', 'sort_order' => $sortBy == 'total_profit' && $sortOrder == 'desc' ? 'asc' : 'desc']) }}">Total Laba</a></th>
                        </tr>
                    </thead>
                    <tbody>
