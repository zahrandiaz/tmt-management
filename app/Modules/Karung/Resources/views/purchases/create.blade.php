                             ...
                             <div class="p-3 border rounded mb-4 bg-light">
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        ...
                                        <input type="text" class="form-control" name="related_expense_description" id="related_expense_description" placeholder="Contoh: Biaya Kuli Angkut, Parkir">
                                    </div>
                                    <div class="col-md-4">
                                        <label for="related_expense_amount" class="form-label">Jumlah Biaya (Rp)</label>
                                        <input type="number" class="form-control" name="related_expense_amount" id="related_expense_amount" placeholder="Contoh: 20000">
                                    </div>
                                </div>
                            </div>
