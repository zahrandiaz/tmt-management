                                            ...
                                            @if($purchase->status != 'Deleted')
                                                ...
                                                @if($purchase->status == 'Completed')
                                                    ...
                                                    @can('karung.cancel_purchases')
                                                        {{-- [MODIFIKASI] Hapus onsubmit, tambahkan class 'cancel-form' --}}
                                                    ...
                                                    @endcan
                                                    @can('karung.delete_purchases')
                                                        {{-- [MODIFIKASI] Hapus onsubmit, tambahkan class 'delete-form' --}}
...
{{-- [BARU] Script untuk SweetAlert2 --}}
@push('footer-scripts')
<script>
    document.addEventListener('DOMContentLoaded', function () {
        // Event listener untuk semua form dengan class 'delete-form'
        ...
        // Event listener untuk semua form dengan class 'cancel-form'
