                                        ...
                                        <td class="text-center">
                                            @if($purchase->status != 'Deleted')
                                                ...
                                                @if($purchase->status == 'Completed')
                                                    ...
                                                    @endcan
                                                    @can('karung.delete_purchases')
                                                    <form action="{{ route('karung.purchases.destroy', $purchase->id) }}" method="POST" class="d-inline" onsubmit="return confirm('PERINGATAN! Menghapus transaksi akan menyembunyikannya dari daftar. Lanjutkan?');">
                                                        @csrf
                                                        @method('DELETE')
