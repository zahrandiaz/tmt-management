    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    {{-- Kode ini sekarang akan berfungsi karena filenya sudah ada --}}
                                ...
                                @forelse ($sales as $sale)
                                    <tr class="{{ $sale->status != 'Completed' ? 'table-secondary text-muted' : '' }}">
                                        ...
                                        <td class="text-center">
                                            @if($sale->status == 'Completed') <span class="badge bg-success">{{ $sale->status }}</span>
                                            @else <span class="badge bg-danger">{{ $sale->status }}</span> @endif
                                        </td>
                                        <td class="text-center">
